...
// Each table stores a single row: { id: 1, data: [...] }
...
const ROLES = ["Cluster Lead", "Technical Analyst", "Commercial Analyst", "Finance Analyst", "Programme Manager"];
...
function DbStatus({ saving, error, lastSaved }) {
  if (error) return <span style={{ fontSize: 10, color: "#dc2626", fontWeight: 700 }}>⚠ DB Error — using local data</span>;
